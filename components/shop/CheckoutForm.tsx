...
export function CheckoutForm({
    ...
    return (
        <form onSubmit={onSubmit} className="space-y-10">
            ...
            {/*
                ไม่ใช้ช่องติ๊กยินยอมตรงนี้ — ข้อมูลที่ขอ (ชื่อ เบอร์ ที่อยู่) เป็นสิ่งจำเป็นต่อการ
                ส่งของตามคำสั่งซื้อที่ลูกค้ากดเอง ไม่ใช่การเก็บไปทำอย่างอื่น จึงแจ้งให้ทราบพอ
                ไม่ต้องบังคับติ๊กเพิ่มขั้นตอน (ต่างจากฟอร์มสมัครวิ่งที่เก็บเลขบัตร ปชช./ข้อมูล
                สุขภาพ ซึ่งยังต้องขอความยินยอมชัดเจน) — ระบบยังบันทึกเวลาไว้เป็นหลักฐานเหมือนเดิม
            */}
            <p className="text-[12px] text-ink-mute leading-relaxed">
                เมื่อกดยืนยัน ถือว่าคุณรับทราบว่าทางร้านจะใช้ชื่อ เบอร์โทร และที่อยู่
                เพื่อจัดส่งสินค้าและติดต่อเรื่องคำสั่งซื้อนี้เท่านั้น
            </p>
