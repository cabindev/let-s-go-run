...
/** ค่าส่งไปรษณีย์ — คงที่ทุกงานที่เปิดใช้ (Event.offerShipping) */
export const SHIPPING_FEE = 55
...
export const DEFAULT_PDPA_NOTICE = `ทั้งนี้การลงทะเบียนข้อมูลส่วนบุคคล โดยมีพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA) ประกอบกับนโยบายคุ้มครองข้อมูลส่วนบุคคล (Privacy Policy) เรื่อง ความเป็นส่วนตัว (Privacy Notice) ในฐานะที่เป็นผู้ควบคุมข้อมูลส่วนบุคคลจะต้องถือปฏิบัติในการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของ "[ชื่อกิจกรรม] ผู้ที่ลงทะเบียนหรือผู้ที่เข้าร่วมกิจกรรม" ซึ่งต่อไปจะเรียกว่า "เจ้าของข้อมูลส่วนบุคคล" ดังนั้น รันลัดโต้ง จึงขอแจ้งความประสงค์ในการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลให้เจ้าของข้อมูลส่วนบุคคลทราบดังต่อไปนี้

รันลัดโต้ง จะเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของเจ้าของข้อมูลส่วนบุคคล ได้แก่ ชื่อ นามสกุล เลขประจำตัวประชาชน ที่อยู่ หมายเลขโทรศัพท์ เพื่อวัตถุประสงค์ในการจัดสวัสดิการและสิทธิประโยชน์อื่นให้แก่ผู้เข้าร่วมกิจกรรม โดยในการเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของเจ้าของข้อมูลส่วนบุคคลดังกล่าว รันลัดโต้ง จะดำเนินการเท่าที่จำเป็นเท่านั้น และจะเก็บรวบรวมข้อมูลส่วนบุคคลดังกล่าวจากเจ้าของข้อมูลส่วนบุคคลโดยตรง ด้วยวิธีการกรอกข้อมูลในเอกสาร บันทึกข้อมูลเสียงหรือภาพ หรือวิธีการทางอิเล็กทรอนิกส์อื่นใดตามแต่ รันลัดโต้ง จะเห็นสมควร

เจ้าของข้อมูลส่วนบุคคลอาจติดต่อกับ รันลัดโต้ง ในฐานะเป็นผู้ควบคุมข้อมูลส่วนบุคคลได้ที่ รันลัดโต้ง หมู่ 2 ต.สันกลาง อ.สันป่าตอง จ.เชียงใหม่ 50120 หรือเพจ รันลัดโต้ง`
